...
Request::Request(const Request &other)
    : _method(other._method), _uri(other._uri), _protocol(other._protocol),
      _host(other._host), _headers(other._headers) {}
...
std::string Request::host(void) const { return _host; }
