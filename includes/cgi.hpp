...
/*   Updated: 2021/08/04 15:34:01 by pcariou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class cgi
{
  ...
  public:
    cgi(const http::Request &request, const t_locInfos &loc, const t_serverData &dataserv)/* throw( cgi::CGIException )*/;;
    cgi(const cgi &);
    ~cgi();
    ...
    char **getCgiEnv(void);
	void Cgi(const http::Request &request, const t_locInfos &loc, const t_serverData &data_serv);
