...
/*   Updated: 2021/07/09 16:59:49 by alienard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class cgi
{
  ...
  public:
    ...
    cgi(const http::Request &request, const t_serverData &data);
    cgi(const cgi &);
    ~cgi();
    cgi &operator=(const cgi &);
    void setCgi(Socket &sock, t_serverData &data);
    void setCgiMetaVar(Socket &sock, t_serverData &data);
    void setCgi(const http::Request &request, const t_serverData &data);
    void setCgiMetaVar(const http::Request &request, const t_serverData &data);
    void setCgiEnv(void);
